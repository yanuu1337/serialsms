...
var require_library = __commonJS({
  "generated/client/runtime/library.js"(exports2, module2) {
    ...
    var _o = (e, r, t, n) => {
      if (r && typeof r == "object" || typeof r == "function") for (let i of xu(r)) !Pu.call(e, i) && i !== t && Vt(e, i, { get: () => r[i], enumerable: !(n = wu(r, i)) || n.enumerable });
      return e;
    };
    ...
    var us = ne((Lg, ls) => {
      "use strict";
      var $c = require("os"), as = require("tty"), de = gi(), { env: G } = process, Qe;
    ...
    var ds = ne((Fg, ps) => {
      ...
      function Ei(e) {
        ...
        if (!jc.supportsColor(e) || e && !e.isTTY) return false;
    ...
    var Ds = ne((Ah, Ne) => {
      "use strict";
      var Ni = require("fs"), Li = require("path"), np = require("os"), ip = require("crypto"), op = Rs(), As = op.version, sp = /(?:^|^)\s*(?:export\s+)?([\w.-]+)(?:\s*=\s*?|:\s+?)(\s*'(?:\\'|[^'])*'|\s*"(?:\\"|[^"])*"|\s*`(?:\\`|[^`])*`|[^#\r\n]+)?\s*(?:#.*)?(?:$|$)/mg;
      function ap(e) {
        let r = {}, t = e.toString();
        t = t.replace(/\r\n?/mg, `
`);
...
`);
    ...
    function pe(e) {
      return Object.assign(e, { optional: () => Ju(e), and: (r) => q(e, r), or: (r) => Hu(e, r), select: (r) => r === void 0 ? Jo(e) : Jo(r, e) });
    }
    function Ju(e) {
    ...
    var ci = { matched: false, value: void 0 };
    function hr(e) {
      return new pi(e, ci);
    }
    var pi = class e {
...
${JSON.stringify(a, null, 2)}`), a;
    ...
    var Ht = {};
    async function es() {
      if (oc(Ht)) return Promise.resolve({ ...Ht, memoized: true });
...
${c}`);
    ...
    var _a3, _b;
    var hg = ((_b = (_a3 = globalThis.process) == null ? void 0 : _a3.versions) == null ? void 0 : _b.node) !== void 0;
    var _a4, _b2;
    var yg = ((_b2 = (_a4 = globalThis.process) == null ? void 0 : _a4.versions) == null ? void 0 : _b2.bun) !== void 0;
    var _a5, _b3;
    var Eg = ((_b3 = (_a5 = globalThis.Deno) == null ? void 0 : _a5.version) == null ? void 0 : _b3.deno) !== void 0;
    var _a6, _b4;
    var bg = ((_b4 = (_a6 = globalThis.process) == null ? void 0 : _a6.versions) == null ? void 0 : _b4.electron) !== void 0;
    var _a7, _b5;
    var wg = ((_b5 = (_a7 = globalThis.navigator) == null ? void 0 : _a7.userAgent) == null ? void 0 : _b5.includes("jsdom")) === true;
    ...
    var _a9, _b7, _c2, _d2;
    var Sg = Zr === "macOS" || ((_a9 = globalThis.navigator) == null ? void 0 : _a9.platform) === "MacIntel" || ((_c2 = (_b7 = globalThis.navigator) == null ? void 0 : _b7.userAgent) == null ? void 0 : _c2.includes(" Mac ")) === true || ((_d2 = globalThis.process) == null ? void 0 : _d2.platform) === "darwin";
    var _a10, _b8;
    var Rg = Zr === "Windows" || ((_a10 = globalThis.navigator) == null ? void 0 : _a10.platform) === "Win32" || ((_b8 = globalThis.process) == null ? void 0 : _b8.platform) === "win32";
    var _a11, _b9, _c3, _d3, _e2;
    var Cg = Zr === "Linux" || ((_b9 = (_a11 = globalThis.navigator) == null ? void 0 : _a11.platform) == null ? void 0 : _b9.startsWith("Linux")) === true || ((_d3 = (_c3 = globalThis.navigator) == null ? void 0 : _c3.userAgent) == null ? void 0 : _d3.includes(" Linux ")) === true || ((_e2 = globalThis.process) == null ? void 0 : _e2.platform) === "linux";
    var _a12, _b10, _c4;
    var Ag = Zr === "iOS" || ((_a12 = globalThis.navigator) == null ? void 0 : _a12.platform) === "MacIntel" && ((_b10 = globalThis.navigator) == null ? void 0 : _b10.maxTouchPoints) > 1 || /iPad|iPhone|iPod/.test((_c4 = globalThis.navigator) == null ? void 0 : _c4.platform);
    var _a13, _b11, _c5, _d4;
    var Ig = Zr === "Android" || ((_a13 = globalThis.navigator) == null ? void 0 : _a13.platform) === "Android" || ((_c5 = (_b11 = globalThis.navigator) == null ? void 0 : _b11.userAgent) == null ? void 0 : _c5.includes(" Android ")) === true || ((_d4 = globalThis.process) == null ? void 0 : _d4.platform) === "android";
    var I = "\x1B[";
    var et = "\x1B]";
    var yr = "\x07";
    var Xr = ";";
    ...
    function br(e) {
      let r = Uc();
      return r || ((e == null ? void 0 : e.config.engineType) === "library" ? "library" : (e == null ? void 0 : e.config.engineType) === "binary" ? "binary" : (e == null ? void 0 : e.config.engineType) === "client" ? "client" : Gc(e));
    }
    function Uc() {
...
`);
    ...
    function ot({ rootEnvPath: e, schemaEnvPath: r }, t = { conflictCheck: "none" }) {
      ...
      let i = null;
      return Ns(n == null ? void 0 : n.path, r) || (i = _s(r)), !n && !i && Fi("No Environment variables loaded"), (i == null ? void 0 : i.dotenvResult.error) ? console.error(ce(W("Schema Env Error: ")) + i.dotenvResult.error) : { message: [n == null ? void 0 : n.message, i == null ? void 0 : i.message].filter(Boolean).join(`
...
Env vars from ${Y(l)} overwrite the ones from ${Y(a)}
    ...
    function _s(e) {
      if (yp(e)) {
        ...
        let r = Mi.default.config({ path: e, debug: process.env.DOTENV_CONFIG_DEBUG ? true : void 0 });
    ...
    function mn(e, r, t) {
      if (r > vp) throw w = true, t && (e.precision = t), Error(Vs);
    ...
    function Je(e, r) {
      ...
      if (r == null ? (w = false, c = E) : c = r, P.precision = c += h, t = J(S), n = t.charAt(0), Math.abs(o = g.e) < 15e14) {
        for (; n < 7 && n != 1 || n == 1 && t.charAt(1) > 3; ) g = g.times(e), t = J(g.d), n = t.charAt(0), f++;
        o = g.e, n > 1 ? (g = new P("0." + t), o++) : g = new P(n + "." + t.slice(1));
      } else return u = mn(P, c + 2, E).times(o + ""), g = Je(new P(n + "." + t.slice(1)), c - h).plus(u), P.precision = E, r == null ? y(g, E, R, w = true) : g;
      for (p = g, l = s = g = L(g.minus(1), g.plus(1), c, 1), d = y(g.times(g), c, 1), i = 3; ; ) {
        ...
        else return y(l, P.precision = E, R, w = true);
    ...
    function $p(e) {
      ...
      if (t = "crypto", i && (this[t] = Vi[t]), (n = e[t]) !== void 0) if (n === true || n === false || n === 0 || n === 1) if (n) if (typeof crypto < "u" && crypto && (crypto.getRandomValues || crypto.randomBytes)) this[t] = true;
      else throw Error(Bs);
      else this[t] = false;
      else throw Error(He + t + ": " + n);
      return this;
...
`);
    ...
    function xd({ callsite: e, message: r, originalMethod: t, isPanic: n, callArguments: i }, o) {
      ...
      let l = Math.max(1, a.lineNumber - 3), u = (_a14 = bn.read(a.fileName)) == null ? void 0 : _a14.slice(l, a.lineNumber), c = u == null ? void 0 : u.lineAt(a.lineNumber);
      if (u && c) {
        let p = Pd(c), d = vd(c);
        if (!d) return s;
...
Note that ${s.bold("include")} statements only accept relation fields.`, a;
    ...
    function Md(e, r) {
      ...
      n && ((_b12 = n.getField(t)) == null ? void 0 : _b12.markAsError(), Jd(n, e.arguments)), r.addErrorMessage((i) => ma(i, t, e.arguments.map((o) => o.name)));
    }
    function $d(e, r) {
      var _a14, _b12, _c6;
...
`);
    ...
    var du = k(xi());
    var mu = require("async_hooks");
    var fu = require("events");
    var gu = k(require("fs"));
    var ei = k(require("path"));
    var oe = class e {
      constructor(r, t) {
...
${er(e)}`;
    ...
    async function yl(e, r) {
      ...
      let o = await ir(), s = ((_a14 = r.generator) == null ? void 0 : _a14.binaryTargets) ?? [], a = s.some((d) => d.native), l = !s.some((d) => d.value === o), u = __filename.match(rf()) === null, c = { searchedLocations: i, generatorBinaryTargets: s, generator: r.generator, runtimeBinaryTarget: o, queryEngineName: El(e, o), expectedLocation: St.default.relative(process.cwd(), r.dirname), errorStack: new Error().stack }, p;
...
`);
    ...
    function Pl({ version: e, binaryTarget: r, title: t, description: n, engineVersion: i, database: o, query: s }) {
      var _a14;
      let a = Go(6e3 - ((s == null ? void 0 : s.length) ?? 0)), l = wl((0, uo.default)(a)), u = n ? `# Description
\`\`\`
${n}
      ...
      async withRetry(r) {
        for (let t = 0; ; t++) {
          ...
          try {
            ...
            this.logEmitter.emit("warn", { message: `Attempt ${t + 1}/${Ol} failed for ${r.actionGerund}: ${i.message ?? "(unknown)"}`, timestamp: /* @__PURE__ */ new Date(), target: "" });
            let o = await Rl(t);
      ...
      async loadEngine() {
        ...
        if (!this.engine) {
          ...
          try {
            ...
            this.adapterPromise || (this.adapterPromise = (_b12 = (_a14 = this.config.adapter) == null ? void 0 : _a14.connect()) == null ? void 0 : _b12.then(Wn));
      ...
      async start() {
        ...
        let r = async () => {
          ...
          try {
            ...
            await ((_a14 = this.engine) == null ? void 0 : _a14.connect(JSON.stringify(t))), this.libraryStarted = true, this.adapterPromise || (this.adapterPromise = (_c6 = (_b12 = this.config.adapter) == null ? void 0 : _b12.connect()) == null ? void 0 : _c6.then(Wn)), await this.adapterPromise, Ce("library started");
          } catch (t) {
...
${a.backtrace}`, { clientVersion: this.config.clientVersion });
      ...
      async requestBatch(r, { transaction: t, traceparent: n }) {
        ...
        this.lastQuery = JSON.stringify(i), this.executingQueryPromise = (_a14 = this.engine) == null ? void 0 : _a14.query(this.lastQuery, JSON.stringify({ traceparent: n }), _l(t));
...
`);
      ...
      }, l = !!(e == null ? void 0 : e.startsWith("prisma://")), u = nn(e), c = !!r, p = l || u;
...
`);
    ...
    var Co = ({ clientMethod: e, activeProvider: r }) => (t) => {
      let n = "", i;
      if (Fn(t)) n = t.sql, i = { values: Qr(t.values), __prismaRawParameters__: true };
    ...
    var Io = class {
      ...
      getGlobalTracingHelper() {
        ...
        return (r == null ? void 0 : r.helper) ?? (t == null ? void 0 : t.helper) ?? Rf;
      }
    };
    function Yl() {
      return new Io();
    ...
    var Xn = class {
      ...
      constructor(r, t) {
        this.logEmitter = t, this.client = r, this.dataloader = new zn({ batchLoader: ol(async ({ requests: n, customDataProxyFetch: i }) => {
          ...
          var _a14;
          let i = ((_a14 = n.transaction) == null ? void 0 : _a14.kind) === "itx" ? ru(n.transaction) : void 0, o = await this.client._engine.request(n.protocolQuery, { traceparent: this.client._tracingHelper.getTraceParent(), interactiveTransaction: i, isWrite: Do(n.protocolQuery.action), customDataProxyFetch: n.customDataProxyFetch });
          return this.mapQueryEngineResult(n, o);
        }, batchBy: (n) => {
          var _a14;
          return ((_a14 = n.transaction) == null ? void 0 : _a14.id) ? `transaction-${n.transaction.id}` : Xl(n.protocolQuery);
        }, batchOrder(n, i) {
          var _a14, _b12;
    ...
    function Df(e, r) {
      return Yn(e) && (r == null ? void 0 : r.kind) === "batch" && e.batchRequestIdx !== r.index;
    }
    function Of(e) {
    ...
    function hu(e) {
      class r {
        ...
        constructor(n) {
          ...
          e = ((_b12 = (_a14 = n == null ? void 0 : n.__internal) == null ? void 0 : _a14.configOverride) == null ? void 0 : _b12.call(_a14, e)) ?? e, cl(e), n && uu(n, e);
          let i = new fu.EventEmitter().on("error", () => {
          });
          this._extensions = Nr.empty(), this._previewFeatures = Hn(e), this._clientVersion = e.clientVersion ?? nu, this._activeProvider = e.activeProvider, this._globalOmit = n == null ? void 0 : n.omit, this._tracingHelper = Yl();
        ...
        _request(n) {
          ...
          let i = n.middlewareArgsMapper ?? Mf, o = { args: i.requestArgsToMiddlewareArgs(n.args), dataPath: n.dataPath, runInTransaction: !!n.transaction, action: n.action, model: n.model }, s = { middleware: { name: "middleware", middleware: true, attributes: { method: "$use" }, active: false }, operation: { name: "operation", attributes: { method: o.action, model: o.model, name: o.model ? `${o.model}.${o.action}` : o.action } } }, a = -1, l = async (u) => {
            ...
            if (c) return this._tracingHelper.runInChildSpan(s.middleware, (S) => c(u, (P) => (S == null ? void 0 : S.end(), l(P))));
...
var require_client = __commonJS({
  "generated/client/index.js"(exports2) {
    ...
    exports2.Prisma.SmsScalarFieldEnum = {
      id: "id",
      createdAt: "createdAt",
      updatedAt: "updatedAt",
      senderId: "senderId",
    ...
    exports2.Prisma.ApiTokenScalarFieldEnum = {
      id: "id",
      createdAt: "createdAt",
      updatedAt: "updatedAt",
      token: "token",
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "/home/mjanus/serialsms/packages/database/generated/client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "/home/mjanus/serialsms/packages/database/prisma/schema.prisma",
        "isCustomOutput": true
      },
      "relativeEnvPaths": {
        "rootEnvPath": null
      ...
      "inlineSchemaHash": "c179d4d424f05407d71a1bd27e10958deccf2ddf8354e6fad8c6dbe31db9fb2b",
      "copyEngine": true
    };
    var fs = require("fs");
